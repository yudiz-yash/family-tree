...
import { FiGitMerge, FiArrowRight, FiPlusCircle, FiUser, FiMapPin, FiPhone, FiEdit2 } from 'react-icons/fi';
        ...
        <div className="container">
          ...
          <div className="welcome-hero mb-4">
            <div className="d-flex justify-content-between align-items-start flex-wrap gap-3">
              <div>
                <h2 className="fw-bold mb-1 family-title-gujarati" style={{ fontSize: 28, color: '#fff' }}>
